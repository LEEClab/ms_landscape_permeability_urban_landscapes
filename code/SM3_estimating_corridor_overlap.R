#' ---
#' title: Supplementary Material III 
#' author: | 
#'     | Several shades of gray: Combining land cover, animal behavior, 
#'     | master plan regulations to assess landscape permeability for birds
